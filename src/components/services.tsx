...
// Todos los servicios (unimos los dos arreglos originales)
const allServices = [
  {
    image: domicilio,
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <div className="w-full md:w-4/5 mx-auto px-4 py-8 lg:py-16">
          {/* Layout dos columnas: video izquierda | servicios derecha */}
          <div className="grid grid-cols-1 lg:grid-cols-2 items-start ">
            ...
            {/* Columna derecha: TODOS los servicios en una cuadrícula de 2 celdas (2 columnas) */}
